...
forum_link: https://collective.flashbots.net/t/flashbots-transparency-report-may-june-2021/869
---
...
Jam with us at the ETHGlobal HackMoney hackathon (Jun 18 — Jul 9, 2021) where Flashbots is providing $8,000 in prizes to winning hacks built around MEV. Additionally, we are giving out $4,000 in joint prizes with Uniswap for a series of ideas built on both Uniswap and Flashbots during the hackathon.
...
The community built [Flashbots Bundle Explorer](https://github.com/martriay/flashbots-explorer), maintained by [martriay](https://twitter.com/martriay), keeps adding new features, now supporting multiple bundles and displaying the assets touched in each transaction as well.
