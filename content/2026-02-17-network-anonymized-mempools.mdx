...
**Mix-Nets**, such as Nym, achieve stronger anonymity at the cost of performance and requiring synchronous rounds. In order to achieve anonymity against global passive adversaries, mix-nets rely batch, reorder and delay messages, which increases end-to-end latency. The result is increased end-to-end latency and higher bandwidth overhead compared to low-latency networks.
