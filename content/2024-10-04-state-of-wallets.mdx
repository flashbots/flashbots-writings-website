...
forum_link: https://collective.flashbots.net/t/state-of-wallets-2024/3936
---
...
Our report aims to illuminate the current state of wallets on Ethereum, building upon the research conducted by [orderflow.art](http://orderflow.art).
...
<LogoGrid>
  {[
    ...
    {
      src: "/img/state_of_wallets_figures/imtoken_wallet_logo.png",
      alt: "imToken Wallet logo",
      caption: "imToken Wallet",
    },
    {
