...
* Unichain and World **use external block building via** [**Rollup-Boost**](https://rollup-boost.flashbots.net/) to support their respective chain visions and ecosystems - Unichain by ordering transactions by priority fee and World by giving priority to verified humans over bots.
