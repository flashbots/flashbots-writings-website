...
* been integrated with MetaMask Swaps, [Rainbow](https://twitter.com/rainbowdotme/status/1552359075580706821?s=20&t=zBhwtvqaoyvB2AHUZpZmgQ) Swaps, NFT Aggregator Gem, [Alchemy](https://docs.alchemy.com/reference/eth-sendprivatetransaction), Quicknode, and more!
...
Today [MEV Protection](https://docs.flashbots.net/flashbots-protect/overview) provides frontrunning protection, no cost for failed transactions, and priority in blocks. Post-merge, under the hood, we will add revert protection to Fast Mode and this will be the default for all transactions. In other words, **all transactions sent to Flashbots Protect RPC after the merge will have frontrunning and revert protection by default. **There are **no changes required** for users sending transactions to [https://rpc.flashbots.net](https://rpc.flashbots.net).
