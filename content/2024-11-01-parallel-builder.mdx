...
This post describes [our open source implementation a](https://github.com/flashbots/rbuilder/tree/develop/crates/rbuilder/src/building/builders/parallel_builder)nd shares early results from testing: in production environments it's already building more valuable blocks 19% of the time and in backtesting it shows potential for up to 50%.
