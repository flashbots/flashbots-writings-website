...
Read more about the discussions [here](https://github.com/flashbots/pm/discussions/52) and the specifications [here](https://docs.flashbots.net/flashbots-auction/releases/alpha-v0.6).
