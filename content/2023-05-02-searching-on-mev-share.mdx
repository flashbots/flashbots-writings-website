...
Wallet users specify their preferred builders in the Protect RPC URL as query params. Searchers specify builders in the [`mev_sendBundle` call](https://github.com/flashbots/mev-share/blob/main/specs/bundles/v0.1.md#privacy).
