...
![Figure 1. Overview of Ethereum wallet ecosytem](/img/state_of_wallets_figures/figure_1_overview_of_ethereum_wallet_ecosystem.png)
...
![Figure 2. Edited Orderflow.art Sankey from September 30, 2024](/img/state_of_wallets_figures/figure_2_orderflow_sankey.png)
...
![Figure 3. Frontend Trading Volume (3 years), Dune Analytics. September 30, 2024.](/img/state_of_wallets_figures/figure_3._frontend_trading_volume.png)

Figure 3. Frontend Trading Volume (3 years), Dune Analytics. September 30, 2024.

![Figure 4. Frontend Transaction Count (3 years), Dune Analytics. September 30, 2024.](/img/state_of_wallets_figures/figure_4._frontend_transaction_count.png)

Figure 4. Frontend Transaction Count (3 years), Dune Analytics. September 30, 2024.

![Figure 5. Frontend Trade Sizes (7 days), Dune Analytics. September 30, 2024.](/img/state_of_wallets_figures/figure_5_frontend_trade_sizes.png)
...
![Figure 6. [30-day builder market share from September 30, 2024.](/img/state_of_wallets_figures/figure_6._30-day_builder_market_share.png)
...
![Figure 7. Banana Gun EOF blocks*.](/img/state_of_wallets_figures/figure_7_banana_gun_eof_blocks.png)

Figure 7. Banana Gun EOF blocks*.

![Figure 8. Banana Gun multiplexed blocks.](/img/state_of_wallets_figures/figure_8_banana_gun_multiplexed_blocks.png)

Figure 8. Banana Gun multiplexed blocks.

![Figure 9. Maestro EOF blocks.](/img/state_of_wallets_figures/figure_9_maestro_eof_blocks.png)

Figure 9. Maestro EOF blocks.

![Figure 10.  Maestro multiplexed blocks.](/img/state_of_wallets_figures/figure_10_maestro_multiplexed_blocks.png)
...
![Figure 11. [MEV supply chain with Order Flow Auctions](/img/state_of_wallets_figures/figure_11_mev_supply_chain.png)
...
![Figure 12. Exclusive Order Flow (EOF) from the seven most prominent EOF providers based on total value](/img/state_of_wallets_figures/figure_12_eof_from_seven_most_eof_providers.png)
...
- Paymaster - The Paymaster is a smart contract that handles the walletʻs gas payment policies.  The Paymaster determines which currency, stablecoins or other ERC-20 tokens, are acceptable for gas payments and allows applications to pay gas fees for their users.
    ...
    ![Figure 14. Weekly Active Smart Accounts](/img/state_of_wallets_figures/figure_14_weekly_active_smart_accounts.png)
    
    Figure 14. [Weekly Active Smart Accounts](https://www.bundlebear.com/overview/all) as of September 30, 2024.
    
    ![Figure 15. [Weekly Bundler Revenue](https://www.bundlebear.com/overview/all) as of September 30, 2024.](/img/state_of_wallets_figures/figure_15_weekly_bundler_revenue.png)
    
    Figure 15. [Weekly Bundler Revenue](https://www.bundlebear.com/overview/all) as of September 30, 2024.
    
    ![Figure 16.  [Weekly Paymaster Gas Spend](https://www.bundlebear.com/overview/all) as of September 30, 2024.](/img/state_of_wallets_figures/figure_16_weekly_paymaster_gas_spend.png)
...
## Proposed Changes to the Order Flow Landscape
...
![Figure 17. Based Preconfirmations for Rollups](/img/state_of_wallets_figures/figure_17_based_preconfs_for_rollups.png)
...
![Figure 18. Mobile authentication via passkeys](/img/state_of_wallets_figures/figure_18_mobile_authentication_via_passkeys.png)
...
![Figure 19. Current message signature](/img/state_of_wallets_figures/figure_19_current_message_signature.png)

Figure 19. Current message signature

![Figure 20. Message signature with EIP-712](/img/state_of_wallets_figures/figure_20_message_signature_with_eip-712.png)
...
![Figure 21.  Uniswapʻs interest in transaction flow control.](/img/state_of_wallets_figures/figure_21_uniswap_interest_in_transaction_flow_control.png)
...
![amber wallet logo.png](/img/state_of_wallets_figures/ambire_wallet_logo.png)

![OKX wallet logo.png](/img/state_of_wallets_figures/okx_wallet_logo.png)

![rainbow wallet logo.png](/img/state_of_wallets_figures/rainbow_wallet_logo.svg)

![im wallet logo.png](/img/state_of_wallets_figures/im_wallet_logo.png)

![base wallet logo.jpg](/img/state_of_wallets_figures/base_wallet_logo.png)

![cw logo.png](/img/state_of_wallets_figures/cw_logo.png)

![safe wallet logo.png](/img/state_of_wallets_figures/safe_wallet_logo.png)

![block daemon logo.png](/img/state_of_wallets_figures/block_daemon_logo.png)
