...
In April 2024, the SEC’s [claim](https://storage.courtlistener.com/recap/gov.uscourts.nysd.599908/gov.uscourts.nysd.599908.105.0.pdf) that Coinbase Wallet acted as a broker was dismissed. Self-custody wallets with swap functionalities generally do not meet most criteria for broker classification do not trigger a majority of the criteria for operating as a broker.

The SEC's argument is based on their allegations that some assets available through these wallets are unregistered securities. This claim forms the basis for attempting to classify the wallets as brokers.

#### SEC v. Consensys

Consensys had proactively sued the SEC in April 2024 over whether the SEC has the legal authority to regulate MetaMask as a securities broker and issuer and was granted an expedited review by the judge in the case. The court proceedings will end by November 26 potentially leading to a decision by the end of this year.
...
Decentralization, both as a concept and a design goal, has helped explain why traditional financial services regulations should not apply to crypto. However, we are now entering a new phase of regulatory discourse where regulators are seeking to define and apply definitions of decentralization to various services, from wallets to decentralized exchanges (DEXs) and beyond.
...
2. These standards of decentralization may not align with the actual goals of regulation.
   This shift in regulatory approach could have significant implications for how crypto services are classified and regulated in the future.
...
- Execution is defined as the act of the user signing their operation
- The protocol executes settlement after the operation is added to a block, attested, and propagated by the network

This framework creates novel regulatory challenges, as in both scenarios, there is no single responsible party other than the users themselves or the protocol as a whole.
...
<LogoGrid>
  {[
    { src: "/img/state_of_wallets_figures/ambire_wallet_logo.png", alt: "Ambire Wallet logo", caption: "Ambire Wallet" },
    { src: "/img/state_of_wallets_figures/okx_wallet_logo.png", alt: "OKX Wallet logo", caption: "OKX Wallet" },
    { src: "/img/state_of_wallets_figures/rainbow_wallet_logo.svg", alt: "Rainbow Wallet logo", caption: "Rainbow Wallet" },
    { src: "/img/state_of_wallets_figures/im_wallet_logo.png", alt: "IM Wallet logo", caption: "IM Wallet" },
    { src: "/img/state_of_wallets_figures/base_wallet_logo.png", alt: "Base Wallet logo", caption: "Base Wallet" },
    { src: "/img/state_of_wallets_figures/cw_logo.png", alt: "CW logo", caption: "CW" },
    { src: "/img/state_of_wallets_figures/safe_wallet_logo.png", alt: "Safe Wallet logo", caption: "Safe Wallet" },
    { src: "/img/state_of_wallets_figures/block_daemon_logo.png", alt: "Block Daemon logo", caption: "Block Daemon" },
  ].map((logo, index) => (
