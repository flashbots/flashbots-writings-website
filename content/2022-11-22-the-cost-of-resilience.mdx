...
[^2] The combined data with mempool block value and MEV-Boost block value can be downloaded from [here](https://drive.google.com/file/d/1wvdO_DbrMu3_Ivld6IeTbGh7QsxjXluC/view).