...
**Tl;dr** [The first article of this series](/writings/2022-09-12-order-flow-auctions-and-centralisation-1.mdx) outlined the threat that exclusive order flow (EOF) poses to the builder market. This article argues that order flow auctions can address part of the EOF problem and explores meaningful differences between two auction design types, while identifying similarities that point to a more fundamental problem.
<!--truncate-->
