...
In addition, some of the research we had been working on internally saw the light of day, such as our work on [MEV formalization](https://writings.flashbots.net/research/formalization-mev) and on [cross-domain MEV](https://arxiv.org/pdf/2112.01472.pdf).
...
In order to encourage others to collaborate, resources have also been pubished such as a [step-by-step walkthrough](https://writings.flashbots.net/writings/the-anatomy-of-an-inspector/) by Robert Miller of how to add a new MEV inspector using as an example a cryptopunk snipers MEV inspector, and a walkthrough of the mev-inspect-py codebase you can watch [here](https://youtu.be/Fuw891c4vA8).
